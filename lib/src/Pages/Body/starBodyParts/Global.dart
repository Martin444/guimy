...
class _ItemPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text("$numero°",style: TextStyle(color: Color(0xffFEAD4C), fontSize: 50.0,fontWeight: FontWeight.bold),),
        CircleAvatar(
          radius: 80.0,
          backgroundColor: Colors.red,
        ),
        SizedBox(height: 10.0,),
                Text("Astrid & Gaston",style: TextStyle(color: Colors.orange, fontSize: 26.0,fontWeight: FontWeight.bold),),
